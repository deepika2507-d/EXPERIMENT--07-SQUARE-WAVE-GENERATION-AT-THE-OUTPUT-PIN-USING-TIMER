...
<img width="790" height="545" alt="image" src="https://github.com/user-attachments/assets/5158f0f4-5886-4e31-9716-8dc4ee84c794" />
...
``` TON = 1 x 50 x 10^-6 = 0.00005 TOFF= 0.1 x 50 x 10^-6 = 0.000005 TOTAL TIME =
 ...
 TON + TOFF = 0.00005 + 0.000005 = 0.000055 FREQUENCY = 1/(TOTAL TIME) =
 18181.82 DUTY CYCLE = TON /(TON+TOFF) = 0.00005/0.000055 = 0.9 IN % =0.9*100 =
 90 % ``
```
